...
us_wave_3 <-  unlist(read.csv('US_Wave_3.csv'))

# Visualizing the data
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_histogram(bins = 30, color = 'black', fill = 'grey') +
  scale_x_continuous('Cases') +
  scale_y_continuous('Frequency') +
  labs(title = "US - Third Wave")

# 5 data summary 
summary(us_wave_3)
var(us_wave_3)
(d <- describe(us_wave_3))
(coef <- d$sd/d$mean)
...
# The third wave: from 6/2021 to 10/2021  
date <- dmy('1/6/2021')

as_tibble(us_wave_3) %>%
  mutate(days = seq(1,length(us_wave_3)), date = date + days(days)) %>%
  ggplot(aes(date,value)) +
  geom_line()+
  labs(title = "US - Third Wave", y = 'Number of Cases', x = 'Date')
...
Exp <- fitdistr(us_wave_3, "exponential")
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  ...
  geom_smooth(aes(us_wave_3,dexp(us_wave_3,est_lambda)),se = F, color = 'red') +
  scale_x_continuous('Cases') +
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_smooth(aes(us_wave_3,ha_exponential(us_wave_3,dexp,pexp,est_lambda)))+
...
fit_ee <- vglm(value ~ 1, fam = expexpff, data = as_tibble(us_wave_3), trace = TRUE, maxit = 99)
...
# Exponentiated exponential distribution
eed <-  lamb_hat*alph_hat * (1 - exp(-1 * lamb_hat * us_wave_3))^(alph_hat - 1) * exp(-1 * lamb_hat * us_wave_3)

ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_histogram(aes(y = ..density..), bins = 30, color = 'black', fill = 'grey') +
  geom_smooth(aes(us_wave_3,eed),se = F, color = 'orange') +
  scale_x_continuous('Cases') +
  scale_y_continuous('Density') +
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_smooth(aes(us_wave_3,ha_ee(us_wave_3,eed,FEE(us_wave_3,alph_hat,lamb_hat),lamb_hat,alph_hat)))+
  scale_y_continuous('h(t)')+
  scale_x_continuous('t')
...
fit <- vglm(value ~ 1, fam = gammaR, data = as_tibble(us_wave_3), trace = TRUE)
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_histogram(aes(y = ..density..), bins = 30, color = 'black', fill = 'grey') +
  geom_smooth(aes(us_wave_3,dgamma(us_wave_3,a,b)), color = 'green', se = F) +
  scale_x_continuous('Cases') +
  scale_y_continuous('Density') +
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_smooth(aes(us_wave_3,ha_3(us_wave_3,dgamma,pgamma,a,b)))+
  scale_y_continuous('h(t)')+
  scale_x_continuous('t')
...
fit_w <- vglm(value ~ 1, fam = weibullRff, data = as_tibble(us_wave_3), trace = TRUE, maxit = 99)
k <- Coef(fit_w)[2]
l <- Coef(fit_w)[1]
l_w <-  logLik(fit_w)
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_histogram(aes(y = ..density..), bins = 30, color = 'black', fill = 'grey') +
  geom_smooth(aes(us_wave_3,dweibull(us_wave_3,k,l)),se = F, color = 'blue') +
  scale_x_continuous('Cases') +
  scale_y_continuous('Density') +
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_smooth(aes(us_wave_3,ha_weibull(us_wave_3,dweibull,pweibull,k,l)))+
  scale_y_continuous('h(t)')+
  scale_x_continuous('t')
...
fit_lg <- vglm(value ~ 1, fam = lognormal, data = as_tibble(us_wave_3), trace = TRUE, maxit = 99)
mu <- Coef(fit_lg)[1]
sd <- Coef(fit_lg)[2]
l_lg <-  logLik(fit_lg)
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_histogram(aes(y = ..density..), bins = 30, color = 'black', fill = 'grey') +
  geom_smooth(aes(us_wave_3,dlnorm(us_wave_3,mu,sd)),se = F, color = 'yellow') +
  scale_x_continuous('Cases') +
  scale_y_continuous('Density') +
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_smooth(aes(us_wave_3,ha_lognormal(us_wave_3,dlnorm,plnorm,mu,sd)))+
  scale_y_continuous('h(t)')+
  scale_x_continuous('t')
...
fit_moe <-  maxlogL(us_wave_3, dist = "dMOE", link = list(over = c("l","t"), fun = c("log_link","log_link")))
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_histogram(aes(y = ..density..), bins = 30, color = 'black', fill = 'grey') +
  geom_smooth(aes(us_wave_3,dMOE(us_wave_3,lae,te)),se = F, color = 'cyan') +
  scale_x_continuous('Cases') +
  scale_y_continuous('Density') +
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_smooth(aes(us_wave_3,ha_moe(us_wave_3,dMOE,FMOE,lae,te)))+
  scale_y_continuous('h(t)')+
  scale_x_continuous('t')
...
fit_moee <-  maxlogL(us_wave_3, dist = "dMOEE", link = list(over = c("a","l","t"), fun = c("log_link","log_link","log_link")))
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_histogram(aes(y = ..density..), bins = 30, color = 'black', fill = 'grey') +
  geom_smooth(aes(us_wave_3,dMOEE(us_wave_3,al,la,t)),se = F, color = 'purple') +
  scale_x_continuous('Cases') +
  scale_y_continuous('Density') +
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_smooth(aes(us_wave_3,ha_moee(us_wave_3,dMOEE,FMOEE,al,la,t)), se = F)+
  scale_y_continuous('h(t)')+
  scale_x_continuous('t') +
  labs(title = "Marshall Olkin EE Distribution")
...
fit_mow <-  maxlogL(us_wave_3, dist = "dMOW", link = list(over = c("a","l","t"), fun = c("log_link","log_link","log_link")))
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_histogram(aes(y = ..density..), bins = 30, color = 'black', fill = 'grey') +
  geom_smooth(aes(us_wave_3,dMOW(us_wave_3,alw,law,tw)),se = F, color = 'brown') +
  scale_x_continuous('Cases') +
  scale_y_continuous('Density') +
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_smooth(aes(us_wave_3,ha_mow(us_wave_3,dMOW,FMOW,alw,law,tw)))+
  scale_y_continuous('h(t)')+
  scale_x_continuous('t')
...
fit_mopee <-  maxlogL(us_wave_3, dist = "dMOPEE", link = list(over = c("a","b","l"), fun = c("log_link","log_link","log_link")))
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_histogram(aes(y = ..density..), bins = 30, color = 'black', fill = 'grey') +
  geom_smooth(aes(us_wave_3,dMOPEE(us_wave_3,alp,beta,lap)),se = F, color = 'purple') +
  scale_x_continuous('Cases') +
  scale_y_continuous('Density') +
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_smooth(aes(us_wave_3,ha_mow(us_wave_3,dMOPEE,FMOPEE,alp,beta,lap)))+
  scale_y_continuous('h(t)')+
  scale_x_continuous('t')
...
ggplot(as_tibble(us_wave_3), aes(value)) +
  geom_histogram(aes(y = ..density..), bins = 30, color = 'black', fill = 'grey') +
  geom_smooth(aes(us_wave_3,dexp(us_wave_3,est_lambda), color = 'Exponential'),se = F) +
  geom_smooth(aes(us_wave_3,eed, color = 'Exponentiated Exponential'),se = F) +
  geom_smooth(aes(us_wave_3,dgamma(us_wave_3,a,b), color = 'Gamma'), se = F) +
  geom_smooth(aes(us_wave_3,dweibull(us_wave_3,k,l), color = "Weibull"),se = F) +
  geom_smooth(aes(us_wave_3,dlnorm(us_wave_3,mu,sd), color = 'Lognormal'),se = F) +
  geom_smooth(aes(us_wave_3,dMOE(us_wave_3,lae,te), color = 'MOE'),se = F) +
  geom_smooth(aes(us_wave_3,dMOEE(us_wave_3,al,la,t), color = 'MOEE'),se = F) +
  geom_smooth(aes(us_wave_3,dMOW(us_wave_3,alw,law,tw), color = 'MOW'),se = F) +
  geom_smooth(aes(us_wave_3,dMOPEE(us_wave_3,alp,beta,lap), color = 'MOPEE'),se = F) +
  scale_x_continuous('Cases') +
  scale_y_continuous('Density') +
...
p1 <- ks.test(us_wave_3,"pexp",est_lambda)

FEE <- function(x,alp,lam){
  (1 - exp(-lam * x) )^alp
}

p2 <- ks.test(us_wave_3,"FEE",alph_hat,lamb_hat)
p3 <- ks.test(us_wave_3,"pgamma",a,b)
p4 <- ks.test(us_wave_3,"pweibull",k,l)
p5 <- ks.test(us_wave_3,"plnorm",mu,sd)

FMOE <- function(x,l,t) {
  (1-exp(-l*x)) / (1- (1-t)*exp(-l*x))
}

p6 <-  ks.test(us_wave_3,"FMOE",lae,te)
...
p7 <-  ks.test(us_wave_3,"FMOEE",al,la,t)
...
p8 <-  ks.test(us_wave_3,"FMOW",alw,law,tw)
...
p9 <-  ks.test(us_wave_3,"FMOPEE",alp,beta,lap)
